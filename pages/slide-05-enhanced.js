...
const Slide05CTA = () => {
  return (
    <div className={`${spaceGrotesk.className} min-h-screen w-full flex flex-col bg-gradient-to-br from-[#F8F7F5] to-[#D4A574] p-6 font-sans antialiased relative`}>
      {/* Top: InstantClaw Logo - Same as Slide 01 Revised */}
      ...
      {/* Main Content - Headlines and core content unchanged */}
      ...
      {/* Bottom Left: Platform Logos - Same as Slide 01 Revised */}
      ...
      {/* Bottom Right: Powered by OpenClaw - Same as Slide 01 Revised */}

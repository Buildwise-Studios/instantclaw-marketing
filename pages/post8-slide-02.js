  ...
  return (
    <div className={`${inter.className} min-h-screen w-full flex flex-col items-center justify-center bg-gradient-to-br from-[#F8F7F5] to-[#D4A574] p-8 font-sans antialiased`}>
      ...
      <div className="text-center mb-6">
        ...
        <p className="text-xl text-[#616061]">Type your travel request</p>
      </div>
      ...
      <div className="w-full max-w-[500px] bg-white rounded-2xl shadow-xl overflow-hidden mb-8">
        ...
        <div className="p-4 space-y-4">
          ...
          <div className="flex justify-end">
            <div className="bg-[#1D1C1D] text-white rounded-2xl rounded-tr-sm px-4 py-3 max-w-[85%]">
              <p className="text-lg">Find me flights to Tokyo under $800 next month</p>
            </div>
          </div>
          ...
          <div className="flex justify-start">
            <div className="bg-gray-100 rounded-2xl rounded-tl-sm px-4 py-3 max-w-[90%]">
              <p className="text-[#1D1C1D] mb-2">I'll search for flights to Tokyo. Checking availability...</p>
              <div className="flex items-center gap-2">
                <div className="w-2 h-2 bg-[#D4A574] rounded-full animate-pulse"></div>
                <span className="text-sm text-[#616061]">Searching 15 airlines...</span>
              </div>
            </div>
          </div>
          ...
          <div className="flex justify-end">
            <div className="bg-[#1D1C1D] text-white rounded-2xl rounded-tr-sm px-4 py-3 max-w-[85%]">
              <p className="text-lg">Also find a 4-star hotel with best reviews</p>
            </div>
          </div>
          ...
          <div className="flex justify-start">
            <div className="bg-gray-100 rounded-2xl rounded-tl-sm px-4 py-3 max-w-[90%]">
              <p className="text-[#1D1C1D]">Got it! Looking for top-rated 4-star hotels in Tokyo...</p>
            </div>
          </div>
        </div>
      ...
      <div className="text-center max-w-[500px]">
        <p className="text-2xl text-[#1D1C1D] font-medium">
          No apps. <span className="text-[#c53131] font-bold">No tabs.</span> Just text.
        </p>
      </div>

      {/* Swipe indicator */}
      <div className="mt-8 flex items-center gap-2 text-[#616061]">
        <span className="text-sm">Swipe to see results →</span>

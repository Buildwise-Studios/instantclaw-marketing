...
const Slide04Staggered = () => {
  ...
  return (
    <div className={`${spaceGrotesk.className} min-h-screen w-full flex flex-col items-center justify-center bg-gradient-to-br from-[#F8F7F5] to-[#D4A574] p-6 font-sans antialiased`}>
      {/* Title */}
      ...
      {/* Bottom Tagline */}
      <p className="mt-8 text-lg text-[#616061] font-medium text-center">

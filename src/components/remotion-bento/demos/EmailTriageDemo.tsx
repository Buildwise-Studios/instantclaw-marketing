...
const emails = [
  {
    ...
    preview: 'Your team shared...',
    important: true,
  },
  {
    subject: 'Meeting tomorrow 10am',
    preview: 'Reminder: All-hands...',
    important: true,
  },
  {
    subject: 'Newsletter March',
    preview: 'Check out the latest...',
    important: false,
  },
];
  ...
  return (
    <div className="flex items-center gap-2 rounded-lg border border-amber-200/50 bg-amber-50/60 px-3 py-2 shadow-sm">
      ...
      <Mail
        className={cn(
          'h-4 w-4 shrink-0',
          important ? 'text-[#D4A574]' : 'text-neutral-400'
        )}
      />
...
export function EmailTriageDemo({ className }: { className?: string }) {
  return (
